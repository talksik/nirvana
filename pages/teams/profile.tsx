  ...
  useEffect(() => {
    (async function() {
      try {
        ...
        if (!returnedUser) {
          userService.createUser(currUser.uid, currUser.email, currUser.photoURL)
        }
        ...
        setFirstName(returnedUser.firstName ?? currUser.displayName.split(" ")[0])
  ...
  return (
    ...
    >
      ...
      <span className="flex flex-col items-start">
        ...
        <span className="text-gray-300 text-xs">Please change your google image to change this.</span>
        <img src={user ? user.avatarUrl : currUser.photoURL} alt="asdf" className="rounded-lg mt-2" />
      </span>
