  ...
  return (
    <>
                ...
                <section className='p-5 flex flex-col bg-gray-100 bg-opacity-25 rounded-lg shadow-md'> 
                    ...
                    {/* list of team members */}
                    {
                        testFriends.map((friend, i) => {
                            return (
                                <span key={i} className={"flex flex-row items-center py-2 px-2 justify-items-start ease-in-out duration-300 " + (selectedChannel == i ? "bg-white bg-opacity-80 scale-105 shadow-2xl" : " ")}>
                                    ...
                                    <span className='flex flex-col mr-10'>
                                        ...
                                        <span className={"text-xs span-sans text-gray-300" + (selectedChannel == i ? "text-black" : " ")}>{friend.role}</span>
                                    </span>
        ...
        <div className='fixed bottom-10 w-full -z-10'>                            
            ...
            <section className={"flex flex-row bg-gray-300 max-w-screen-md mx-auto p-5 shadow-xl rounded-xl justify-between ease-in-out duration-300 scale-0" + (selectedChannel != null ? "scale-100" : " ")}>
                <span className='flex flex-row'>
                    <span className='relative flex mr-2'>
                        ...
                        <Image src={"/avatars/svg/Artboards_Diversity_Avatars_by_Netguru-" + (selectedChannel == null ? "" : testFriends[selectedChannel].systemAvatar) + ".svg"} alt="profile" width={50} height={50} />
                    </span>

                    <span className='flex flex-col'>
                        <span className="text-sm text-black font-bold">{selectedChannel == null ? "" : testFriends[selectedChannel].name} </span>

                        <span className={"text-xs text-gray-300"}>{selectedChannel == null ? "" : testFriends[selectedChannel].role}</span>
                    </span> 
                </span>
